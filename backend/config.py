...
class Settings(BaseSettings):
    ...
    VENUE_CLOUD_BASE_URL: str = "https://47.100.44.36"
    VENUE_PUBLIC_BASE_URL: str = "https://47.100.44.36"
    VENUE_CLOUD_CLIENT_CERT_PATH: str = ""
    VENUE_CLOUD_CLIENT_KEY_PATH: str = ""
    VENUE_CLOUD_REQUEST_SIGNING_KEY_PATH: str = ""
    VENUE_CLOUD_RESPONSE_SIGNING_PUBLIC_KEY_PATH: str = ""
    VENUE_CLOUD_DECRYPTION_KEY_DIR: str = ""
