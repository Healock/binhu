...
ACTION_LABELS: dict[str, str] = {
    ...
    "registry.watch_category.create": "人员标记分类创建",
    "registry.watch_category.update": "修改人员标记分类",
    "registry.watch_person.create": "人员标记档案创建",
    "registry.watch_person.update": "修改人员标记档案",
    "registry.watch_assignment.create": "新增人员标记",
    "registry.watch_assignment.update": "修改人员标记",
...
TARGET_TYPE_LABELS: dict[str, str] = {
    ...
    "watch_category": "人员标记分类",
    "watch_person": "人员标记档案",
    "watch_assignment": "人员标记",
