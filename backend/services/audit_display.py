...
ACTION_LABELS: dict[str, str] = {
    ...
    "help_document.update": "修改帮助文档",
    "help_document.reset": "恢复内置帮助文档",
    ...
    "online.local_update": "修改本地业务数据",
    "online.local_create": "新增本地业务数据",
    "online.local_bulk_create": "批量新增本地业务数据",
    "online.local_delete": "归档并移除本地业务数据",
    "mobile_tasks.address_match_confirm": "确认任务小区归属",
    "mobile_tasks.address_match.manual_unmatched": "标注任务无匹配小区",
    ...
    "environment_account.password.reset": "重置隔离环境账号密码",
    "user.delete": "删除用户",
    ...
    "venue.visit.delete": "删除场所登记记录",
    "public_form.drinking_report.create": "创建饮酒报备二维码",
    "public_form.drinking_report.status": "修改饮酒报备二维码状态",
    "public_form.drinking_report.rotate": "轮换饮酒报备二维码",
    "drinking_report.export_pdf": "导出饮酒报备单",
...
TARGET_TYPE_LABELS: dict[str, str] = {
    ...
    "diagnostic_job": "问题诊断任务",
    "system": "系统",
    "user": "用户账号",
    "environment_account": "隔离环境账号",
    "oauth": "腾讯文档授权",
    "area": "片区",
    "community": "社区",
    "grid_member": "人员",
    ...
    "mobile_task": "流口核查任务",
    "mobile_task_address_match": "任务小区归属",
    "online_task": "在线核查任务",
    "local_source_rows": "本地在线数据行",
