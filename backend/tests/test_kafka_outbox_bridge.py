...
@pytest.mark.parametrize("change",[{"task_id":None},{"source_id":None},{"operation_id":None},{"event_type":"unapproved"},{"changed_fields_json":"[\"phone\"]"}, {"source_id":True}, {"aggregate_revision":True}, {"aggregate_revision":"5"}])
