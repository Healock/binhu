...
install -d -o root -g root -m 0755 /usr/local/libexec/binhu-dev-application
install -o root -g root -m 0644 deploy/__init__.py /usr/local/libexec/binhu-dev-application/__init__.py
install -o root -g root -m 0644 deploy/environments/development_application_gateway.py /usr/local/libexec/binhu-dev-application/development_application_gateway.py
...
paths=(Path('/usr/local/bin/binhu-dev-application-gateway'),Path('/usr/local/libexec/binhu-dev-application-gateway'),Path('/usr/local/libexec/binhu-dev-application/development_application_gateway.py'),Path('/etc/sudoers.d/binhu-dev-application'))
